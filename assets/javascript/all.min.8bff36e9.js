function jBox(type, options) {
    this.options = {
        ...
        Confirm: {
            ...
            _onAttach: function(t) {
                if (!this.options.confirm) {
                    var e = t.attr("onclick") ? t.attr("onclick") : t.attr("href") ? t.attr("target") ? 'window.open("' + t.attr("href") + '", "' + t.attr("target") + '");' : 'window.location.href = "' + t.attr("href") + '";' : "";
                    t.prop("onclick", null).data("jBox-Confirm-submit", e)
                }
            },
            _onCreated: function() {
        ...
        Notice: {
            ...
            _onOpen: function() {
                jQuery.each(jQuery(".jBox-Notice"), function(t, e) {
                    return e = jQuery(e), e.attr("id") != this.id && e.data("jBox-Notice-position") == this.options.attributes.x + "-" + this.options.attributes.y ? this.options.stack ? void e.css("margin-" + this.options.attributes.y, parseInt(e.css("margin-" + this.options.attributes.y)) + this.wrapper.outerHeight() + 10) : void e.data("jBox").close({
                        ignoreDelay: !0
                    }) : void 0
        ...
        Image: {
            ...
            preventDefault: !0,
            _onInit: function() {
                this.images = this.currentImage = {}, this.imageZIndex = 1, this.attachedElements && jQuery.each(this.attachedElements, function(t, e) {
                    if (e = jQuery(e), !e.data("jBox-image-gallery")) {
                        var n = e.attr(this.options.gallery) || "default";
                        !this.images[n] && (this.images[n] = []), this.images[n].push({
                            src: e.attr(this.options.src),
                            label: e.attr(this.options.imageLabel) || ""
                        }), "title" == this.options.imageLabel && e.removeAttr("title"), e.data("jBox-image-gallery", n), e.data("jBox-image-id", this.images[n].length - 1)
                    }
                }.bind(this));
                var t = function(t, e, n, i) {
                        if (!jQuery("#jBox-image-" + t + "-" + e).length) {
                            {
                                var o = jQuery("<div/>", {
                                    id: "jBox-image-" + t + "-" + e,
                                    "class": "jBox-image-container"
                                }).css({
                                    backgroundImage: "url(" + this.images[t][e].src + ")",
                                    backgroundSize: this.options.imageSize,
                                    opacity: i ? 1 : 0,
                                    zIndex: n ? 0 : this.imageZIndex++
                                }).appendTo(this.content);
                                jQuery("<div/>", {
                                    id: "jBox-image-label-" + t + "-" + e,
                                    "class": "jBox-image-label" + (i ? " active" : "")
                                }).html(this.images[t][e].label).appendTo(this.imageLabel)
                            }!i && !n && o.animate({
                                opacity: 1
                    ...
                    e = function(t, e) {
                        jQuery(".jBox-image-label.active").removeClass("active"), jQuery("#jBox-image-label-" + t + "-" + e).addClass("active")
                    };
                this.showImage = function(n) {
                    if ("open" != n) {
                        var i = this.currentImage.gallery,
                            o = this.currentImage.id + (1 * ("prev" == n) ? -1 : 1);
                        o = o > this.images[i].length - 1 ? 0 : 0 > o ? this.images[i].length - 1 : o
                    } else {
                        ...
                        jQuery(".jBox-image-pointer-prev, .jBox-image-pointer-next").css({
                            display: this.images[i].length > 1 ? "block" : "none"
                        })
                    }
                    if (this.currentImage = {
                            gallery: i,
                            id: o
                        }, jQuery("#jBox-image-" + i + "-" + o).length) jQuery("#jBox-image-" + i + "-" + o).css({
                        zIndex: this.imageZIndex++,
                        opacity: 0
                    }).animate({
                        opacity: 1
                    }, "open" == n ? 0 : this.options.imageFade), e(i, o);
                    else {
                        this.wrapper.addClass("jBox-loading"); {
                            jQuery('<img src="' + this.images[i][o].src + '">').load(function() {
                                t(i, o, !1), e(i, o), this.wrapper.removeClass("jBox-loading")
                            }.bind(this))
                        }
                    }
                    var r = o + 1;
                    r = r > this.images[i].length - 1 ? 0 : 0 > r ? this.images[i].length - 1 : r, !jQuery("#jBox-image-" + i + "-" + r).length && jQuery('<img src="' + this.images[i][r].src + '">').load(function() {
                        t(i, r, !0)
                    })
                }
            },
    ...
    return this.IE8 = -1 != userAgent.indexOf("msie") && 8 == parseInt(userAgent.split("msie")[1]), this.prefix = -1 != userAgent.indexOf("webkit") ? "-webkit-" : "", this._getOpp = function(t) {
        ...
        if (!this.wrapper) {
            ...
            if (this.wrapper.appendTo(this.options.appendTo), this.options.pointer) {
                if (this.pointer = {
                    ...
                    var e = this.options.pointer.split(":");
                    e[0] && (this.pointer.align = e[0]), e[1] && (this.pointer.offset = parseInt(e[1]))
                }
            ...
            if (this.setContent(this.options.content, !0), this.setTitle(this.options.title, !0), this.options.draggable) {
                var n = "title" == this.options.draggable ? this.titleContainer : this.options.draggable.length > 0 ? this.options.draggable : this.options.draggable.selector ? jQuery(this.options.draggable.selector) : this.wrapper;
                n.addClass("jBox-draggable").on("mousedown", function(t) {
                    if (2 != t.button && !jQuery(t.target).hasClass("jBox-noDrag") && !jQuery(t.target).parents(".jBox-noDrag").length) {
                        ...
                        var e = this.wrapper.outerHeight(),
                            n = this.wrapper.outerWidth(),
                            i = this.wrapper.offset().top + e - t.pageY,
                            o = this.wrapper.offset().left + n - t.pageX;
        ...
        var e = function(t, e) {
            return "center" == this.options.position[e] ? void(this.pos[t] -= Math.ceil(this.dimensions[e] / 2)) : (this.pos[t] += t == this.options.position[e] ? -1 * this.dimensions[e] - this.options.offset[e] : this.options.offset[e], this.pos[t])
        }.bind(this);
        this.wrapper.css({
            left: e("left", "x"),
            top: e("top", "y")
        ...
        if (this.options.closeOnEsc && jQuery(document).on("keyup.jBox-" + this.id, function(t) {
            ...
            var t, e = 0,
                ...
                i = function() {
                    ...
                    t || (i - e > n && (this.options.reposition && this.position(), this.options.adjustTracker && this._adjustPosition(), e = i), t = setTimeout(function() {
                        t = null, e = (new Date).getTime(), this.options.reposition && this.position(), this.options.adjustTracker && this._adjustPosition()
                    }.bind(this), n))
                }.bind(this);
        ...
        if (!this.IE8) {
            ...
            jQuery.each(["pulse", "tada"], function(e, n) {
                t[n + "Open"] = t[n + "Close"] = t[n]
            });
            var e = function(e, n) {
                    return keyframe_css = "@" + this.prefix + "keyframes jBox-animation-" + this.options.animation[e] + "-" + e + (n ? "-" + n : "") + " {", jQuery.each(t[this.options.animation[e]].css, function(i, o) {
                        var r = n ? o[1].replace("%XY", this._getXY(n).toUpperCase()) : o[1];
                        t[this.options.animation[e]].positions && (r = r.replace("%V", t[this.options.animation[e]].positions[n][o[0]])), keyframe_css += o[0] + " {" + this.prefix + "transform:" + r + ";}"
                ...
                n = "";
            jQuery.each(["open", "close"], function(i, o) {
                return this.options.animation[o] && t[this.options.animation[o]] && ("close" != o || this.options.fade) ? void(t[this.options.animation[o]].positions ? jQuery.each(["top", "right", "bottom", "left"], function(t, i) {
                    n += e(o, i)
                }) : n += e(o)) : ""
            }.bind(this)), jQuery("<style/>").append(n).appendTo(jQuery("head"))
        }
        ...
        if (!this.IE8) {
            ...
            var n = "jBox-animation-" + this.options.animation[t] + "-" + t + " jBox-animation-" + this.options.animation[t] + "-" + t + "-" + e;
            ...
            "close" == t && (i = Math.min(i, this.options.fade)), setTimeout(function() {
                this.wrapper.removeClass(n)
            }.bind(this), i)
        }
    }, this._abortAnimation = function() {
        if (!this.IE8) {
            var t = "jBox-animation",
                e = this.wrapper.attr("class").split(" ").filter(function(e) {
                    return 0 !== e.lastIndexOf(t, 0)
                });
            this.wrapper.attr("class", e.join(" "))
        }
        ...
        e.bottom = e.top + e.y, e.right = e.left + e.x;
        var n = e.top > this.pos.top - (this.options.adjustDistance.top || 0),
            i = e.right < this.pos.left + this.dimensions.x + (this.options.adjustDistance.right || 0),
            o = e.bottom < this.pos.top + this.dimensions.y + (this.options.adjustDistance.bottom || 0),
            r = e.left > this.pos.left - (this.options.adjustDistance.left || 0),
            s = r ? "left" : i ? "right" : null,
            a = n ? "top" : o ? "bottom" : null,
            l = s || a;
        if (l) {
            "move" == this.options.adjustPosition || s != this.outside && a != this.outside || ("mouse" == this.target && (this.outside = "right"), ("top" == this.outside || "left" == this.outside ? e[this._getXY(this.outside)] - (this.targetDimensions[this._getTL(this.outside)] - e[this._getTL(this.outside)]) - this.targetDimensions[this._getXY(this.outside)] + this.options.offset[this._getXY(this.outside)] : this.targetDimensions[this._getTL(this.outside)] - e[this._getTL(this.outside)] - this.options.offset[this._getXY(this.outside)]) > this.dimensions[this._getXY(this.outside)] + parseInt(this.options.adjustDistance[this._getOpp(this.outside)]) && (this.wrapper.css(this._getTL(this.outside), this.pos[this._getTL(this.outside)] + (this.dimensions[this._getXY(this.outside)] + this.options.offset[this._getXY(this.outside)] * ("top" == this.outside || "left" == this.outside ? -2 : 2) + this.targetDimensions[this._getXY(this.outside)]) * ("top" == this.outside || "left" == this.outside ? 1 : -1)), this.pointer && this.wrapper.removeClass("jBox-pointerPosition-" + this.pointer.position).addClass("jBox-pointerPosition-" + this._getOpp(this.pointer.position)).css("padding", 0).css("padding-" + this.outside, this.pointer.dimensions[this._getXY(this.outside)]), this.pointer && this.pointer.element.attr("class", "jBox-pointer jBox-pointer-" + this.outside), this.positionAdjusted = !0, this.flipped = !0));
            var c = "x" == this._getXY(this.outside) ? a : s;
            if (this.pointer && "flip" != this.options.adjustPosition && this._getXY(c) == this._getOpp(this._getXY(this.outside))) {
                if ("center" == this.pointer.align) var u = this.dimensions[this._getXY(c)] / 2 - this.pointer.dimensions[this._getOpp(this.pointer.xy)] / 2 - parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) * (c != this._getTL(c) ? -1 : 1);
                else var u = c == this.pointer.alignAttribute ? parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) : this.dimensions[this._getXY(c)] - parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) - this.pointer.dimensions[this._getXY(c)];
                spaceDiff = c == this._getTL(c) ? e[this._getTL(c)] - this.pos[this._getTL(c)] + this.options.adjustDistance[c] : -1 * (e[this._getOpp(this._getTL(c))] - this.pos[this._getTL(c)] - this.options.adjustDistance[c] - this.dimensions[this._getXY(c)]), c == this._getOpp(this._getTL(c)) && this.pos[this._getTL(c)] - spaceDiff < e[this._getTL(c)] + this.options.adjustDistance[this._getTL(c)] && (spaceDiff -= e[this._getTL(c)] + this.options.adjustDistance[this._getTL(c)] - (this.pos[this._getTL(c)] - spaceDiff)), spaceDiff = Math.min(spaceDiff, u), spaceDiff <= u && spaceDiff > 0 && (this.pointer.element.css("margin-" + this.pointer.alignAttribute, parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) - spaceDiff * (c != this.pointer.alignAttribute ? -1 : 1)), this.wrapper.css(this._getTL(c), this.pos[this._getTL(c)] + spaceDiff * (c != this._getTL(c) ? -1 : 1)), this.positionAdjusted = !0)
            }
        }
    ...
    t.prototype.needsClick = function(t) {
        ...
        return i && !o && (l = u.fastClickScrollParent, l && l.fastClickLastScrollTop !== l.scrollTop) ? !0 : (this.needsClick(u) || (t.preventDefault(), this.sendClick(u, t)), !1)
...
function(t, e) {
    function n(t) {
        var e = t.length,
            n = lt.type(t);
        return lt.isWindow(t) ? !1 : 1 === t.nodeType && e ? !0 : "array" === n || "function" !== n && (0 === e || "number" == typeof e && e > 0 && e - 1 in t)
    }
    ...
    function o(t, n, i, o) {
        if (lt.acceptData(t)) {
            var r, s, a = lt.expando,
                ...
                u = c ? lt.cache : t,
                p = c ? t[a] : t[a] && a;
            if (p && u[p] && (o || u[p].data) || !l || i !== e) return p || (c ? t[a] = p = K.pop() || lt.guid++ : p = a), u[p] || (u[p] = {}, c || (u[p].toJSON = lt.noop)), ("object" == typeof n || "function" == typeof n) && (o ? u[p] = lt.extend(u[p], n) : u[p].data = lt.extend(u[p].data, n)), r = u[p], o || (r.data || (r.data = {}), r = r.data), i !== e && (r[lt.camelCase(n)] = i), l ? (s = r[n], null == s && (s = r[lt.camelCase(n)])) : s = r, s
        }
    }
    ...
    function r(t, e, n) {
        if (lt.acceptData(t)) {
            ...
            if (l[c]) {
                ...
                }(n || (delete l[c].data, a(l[c]))) && (s ? lt.cleanData([t], !0) : lt.support.deleteExpando || l != l.window ? delete l[c] : l[c] = null)
            }
        }
    }
    ...
    function s(t, n, i) {
        if (i === e && 1 === t.nodeType) {
            ...
            if (i = t.getAttribute(o), "string" == typeof i) {
                try {
                    i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : jt.test(i) ? lt.parseJSON(i) : i
                } catch (r) {}
                lt.data(t, n, i)
            } else i = e
        }
    ...
    function p(t, e, n) {
        ...
        if ("string" == typeof e) {
            ...
            if (qt.test(e)) return lt.filter(e, i, !n);
            e = lt.filter(e, i)
        }
    ...
    function y(t, e) {
        if (1 === e.nodeType && lt.hasData(t)) {
            ...
            if (a) {
                ...
                for (n in a)
                    for (i = 0, o = a[n].length; o > i; i++) lt.event.add(e, n, a[n][i])
            }
    ...
    function x(t, n) {
        ...
        if (!s)
            for (s = [], i = t.childNodes || t; null != (o = i[r]); r++) !n || lt.nodeName(o, n) ? s.push(o) : lt.merge(s, x(o, n));
        return n === e || n && lt.nodeName(t, n) ? lt.merge([t], s) : s
    }
    ...
    function _(t, e) {
        if (e in t) return e;
        for (var n = e.charAt(0).toUpperCase() + e.slice(1), i = e, o = je.length; o--;)
            if (e = je[o] + n, e in t) return e;
        return i
    }
    ...
    function C(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = lt._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && w(i) && (r[s] = lt._data(i, "olddisplay", S(i.nodeName)))) : r[s] || (o = w(i), (n && "none" !== n || !o) && lt._data(i, "olddisplay", o ? n : lt.css(i, "display"))));
    ...
    function k(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += lt.css(t, n + Ce[r], !0, o)), i ? ("content" === n && (s -= lt.css(t, "padding" + Ce[r], !0, o)), "margin" !== n && (s -= lt.css(t, "border" + Ce[r] + "Width", !0, o))) : (s += lt.css(t, "padding" + Ce[r], !0, o), "padding" !== n && (s += lt.css(t, "border" + Ce[r] + "Width", !0, o)));
        return s
    }
    ...
    function T(t, e, n) {
        var i = !0,
            ...
            r = ue(t),
            s = lt.support.boxSizing && "border-box" === lt.css(t, "boxSizing", !1, r);
        if (0 >= o || null == o) {
            if (o = pe(t, e, r), (0 > o || null == o) && (o = t.style[e]), ve.test(o)) return o;
            i = s && (lt.support.boxSizingReliable || o === t.style[e]), o = parseFloat(o) || 0
        }
    ...
    function S(t) {
        var e = Y,
            n = be[t];
        return n || (n = E(t, e), "none" !== n && n || (ce = (ce || lt("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(e.documentElement), e = (ce[0].contentWindow || ce[0].contentDocument).document, e.write("<!doctype html><html><body>"), e.close(), n = E(t, e), ce.detach()), be[t] = n), n
    }
    ...
    function A(t, e, n, i) {
        ...
        if (lt.isArray(e)) lt.each(e, function(e, o) {
            n || Te.test(t) ? i(t, o) : A(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
        });
    ...
    function O(t, n, i, o) {
        function r(l) {
            var c;
            return s[l] = !0, lt.each(t[l] || [], function(t, l) {
                var u = l(n, i, o);
    ...
    function H(t, e) {
        lt.each(e, function(e, n) {
            for (var i = (rn[e] || []).concat(rn["*"]), o = 0, r = i.length; r > o; o++)
    ...
    function F(t, e, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var e = Je || $(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
        ...
        for (P(u, c.opts.specialEasing); s > r; r++)
            if (i = on[r].call(c, t, u, c.opts)) return i;
    ...
    function P(t, e) {
        var n, i, o, r, s;
        for (o in t)
            if (i = lt.camelCase(o), r = e[i], n = t[o], lt.isArray(n) && (r = n[1], n = t[o] = n[0]), o !== i && (t[i] = n, delete t[o]), s = lt.cssHooks[i], s && "expand" in s) {
    ...
    function Q(t, e, n) {
        var i, o, r, s, a, l, c, u, p, d = this,
            h = t.style,
            f = {},
            g = [],
            m = t.nodeType && w(t);
        n.queue || (u = lt._queueHooks(t, "fx"), null == u.unqueued && (u.unqueued = 0, p = u.empty.fire, u.empty.fire = function() {
            u.unqueued || p()
        }), u.unqueued++, d.always(function() {
            d.always(function() {
                u.unqueued--, lt.queue(t, "fx").length || u.empty.fire()
            })
        })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === lt.css(t, "display") && "none" === lt.css(t, "float") && (lt.support.inlineBlockNeedsLayout && "inline" !== S(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", lt.support.shrinkWrapBlocks || d.always(function() {
        ...
        if (r = g.length) {
            ...
            for (o = 0; r > o; o++) i = g[o], c = d.createTween(i, m ? a[i] : 0), f[i] = a[i] || lt.style(t, i), i in a || (a[i] = c.start, m && (c.end = c.start, c.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    var R, X, U = typeof e,
        ...
        _t = function(t) {
            (Y.addEventListener || "load" === t.type || "complete" === Y.readyState) && (wt(), lt.ready())
        },
        wt = function() {
            Y.addEventListener ? (Y.removeEventListener("DOMContentLoaded", _t, !1), t.removeEventListener("load", _t, !1)) : (Y.detachEvent("onreadystatechange", _t), t.detachEvent("onload", _t))
        };
    lt.fn = lt.prototype = {
        jquery: tt,
        constructor: lt,
        init: function(t, n, i) {
            ...
            if (!t) return this;
            if ("string" == typeof t) {
                if (o = "<" === t.charAt(0) && ">" === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : dt.exec(t), !o || !o[1] && n) return !n || n.jquery ? (n || i).find(t) : this.constructor(n).find(t);
                if (o[1]) {
                    if (n = n instanceof lt ? n[0] : n, lt.merge(this, lt.parseHTML(o[1], n && n.nodeType ? n.ownerDocument || n : Y, !0)), ht.test(o[1]) && lt.isPlainObject(n))
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[1] || {}, l = 2), "object" == typeof a || lt.isFunction(a) || (a = {}), c === l && (a = this, --l); c > l; l++)
            if (null != (r = arguments[l]))
                for (o in r) t = a[o], i = r[o], a !== i && (u && i && (lt.isPlainObject(i) || (n = lt.isArray(i))) ? (n ? (n = !1, s = t && lt.isArray(t) ? t : []) : s = t && lt.isPlainObject(t) ? t : {}, a[o] = lt.extend(u, s, i)) : i !== e && (a[o] = i));
        return a
    }, lt.extend({
        noConflict: function(e) {
            return t.$ === lt && (t.$ = Z), e && t.jQuery === lt && (t.jQuery = G), lt
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(t) {
            if (t === !0 ? !--lt.readyWait : !lt.isReady) {
                ...
                lt.isReady = !0, t !== !0 && --lt.readyWait > 0 || (R.resolveWith(Y, [lt]), lt.fn.trigger && lt(Y).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(t) {
            return null == t ? t + "" : "object" == typeof t || "function" == typeof t ? J[rt.call(t)] || "object" : typeof t
        },
        ...
        parseJSON: function(n) {
            return t.JSON && t.JSON.parse ? t.JSON.parse(n) : null === n ? n : "string" == typeof n && (n = lt.trim(n), n && ft.test(n.replace(mt, "@").replace(yt, "]").replace(gt, ""))) ? Function("return " + n)() : (lt.error("Invalid JSON: " + n), e)
        },
        parseXML: function(n) {
            var i, o;
        ...
        camelCase: function(t) {
            return t.replace(vt, "ms-").replace(xt, bt)
        },
        ...
        access: function(t, n, i, o, r, s, a) {
            ...
            if ("object" === lt.type(i)) {
                r = !0;
                for (l in i) lt.access(t, n, l, i[l], !0, s, a)
            } else if (o !== e && (r = !0, lt.isFunction(o) || (a = !0), u && (a ? (n.call(t, o), n = null) : (u = n, n = function(t, e, n) {
        ...
        if (!R)
            if (R = lt.Deferred(), "complete" === Y.readyState) setTimeout(lt.ready);
            else if (Y.addEventListener) Y.addEventListener("DOMContentLoaded", _t, !1), t.addEventListener("load", _t, !1);
        else {
    ...
    lt.Callbacks = function(t) {
            ...
            d = {
                ...
                remove: function() {
                    return c && lt.each(arguments, function(t, e) {
                        for (var i;
                            (i = lt.inArray(e, c, i)) > -1;) c.splice(i, 1), n && (s >= i && s--, a >= i && a--)
                    }), this
                },
                has: function(t) {
                ...
                fireWith: function(t, e) {
                    return e = e || [], e = [t, e.slice ? e.slice() : e], !c || r && !u || (n ? u.push(e) : p(e)), this
                },
                fire: function() {
                        ...
                        return lt.Deferred(function(n) {
                            lt.each(e, function(e, r) {
                                ...
                                o[r[1]](function() {
                                    ...
                                    t && lt.isFunction(t.promise) ? t.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[s + "With"](this === i ? n.promise() : this, a ? [t] : arguments)
                                })
                            }), t = null
                        }).promise()
                    },
        ...
        when: function(t) {
            ...
            if (s > 1)
                for (e = Array(s), n = Array(s), i = Array(s); s > o; o++) r[o] && lt.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, e)) : --a;
            return a || l.resolveWith(i, r), l.promise()
        }
    }), lt.support = function() {
        var e, n, i, o, r, s, a, l, c, u, p = Y.createElement("div");
        ...
        r = Y.createElement("select"), a = r.appendChild(Y.createElement("option")), o = p.getElementsByTagName("input")[0], i.style.cssText = "top:1px;float:left;opacity:.5", e = {
        ...
        return p.style.backgroundClip = "content-box", p.cloneNode(!0).style.backgroundClip = "", e.clearCloneStyle = "content-box" === p.style.backgroundClip, lt(function() {
            ...
            s && (n = Y.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(n).appendChild(p), p.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", o = p.getElementsByTagName("td"), o[0].style.cssText = "padding:0;margin:0;border:0;display:none", c = 0 === o[0].offsetHeight, o[0].style.display = "", o[1].style.display = "none", e.reliableHiddenOffsets = c && 0 === o[0].offsetHeight, p.innerHTML = "", p.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", e.boxSizing = 4 === p.offsetWidth, e.doesNotIncludeMarginInBodyOffset = 1 !== s.offsetTop, t.getComputedStyle && (e.pixelPosition = "1%" !== (t.getComputedStyle(p, null) || {}).top, e.boxSizingReliable = "4px" === (t.getComputedStyle(p, null) || {
                width: "4px"
            }).width, i = p.appendChild(Y.createElement("div")), i.style.cssText = p.style.cssText = r, i.style.marginRight = i.style.width = "0", p.style.width = "1px", e.reliableMarginRight = !parseFloat((t.getComputedStyle(i, null) || {}).marginRight)), typeof p.style.zoom !== U && (p.innerHTML = "", p.style.cssText = r + "width:1px;padding:1px;display:inline;zoom:1", e.inlineBlockNeedsLayout = 3 === p.offsetWidth, p.style.display = "block", p.innerHTML = "<div></div>", p.firstChild.style.width = "5px", e.shrinkWrapBlocks = 3 !== p.offsetWidth, e.inlineBlockNeedsLayout && (s.style.zoom = 1)), s.removeChild(n), n = p = o = i = null)
        }), n = r = s = a = i = o = null, e
    }();
    var jt = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        kt = /([A-Z])/g;
    lt.extend({
        ...
        data: function(t, n) {
            ...
            if (t === e) {
                if (this.length && (l = lt.data(r), 1 === r.nodeType && !lt._data(r, "parsedAttrs"))) {
                    for (i = r.attributes; i.length > a; a++) o = i[a].name, o.indexOf("data-") || (o = lt.camelCase(o.slice(5)), s(r, o, l[o]));
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                return n === e ? r ? s(r, t, lt.data(r, t)) : null : (this.each(function() {
                    lt.data(this, t, n)
                }), e)
        ...
        queue: function(t, n, i) {
            var o;
            return t ? (n = (n || "fx") + "queue", o = lt._data(t, n), i && (!o || lt.isArray(i) ? o = lt._data(t, n, lt.makeArray(i)) : o.push(i)), o || []) : e
        },
        ...
        queue: function(t, n) {
            var i = 2;
            return "string" != typeof t && (n = t, t = "fx", i--), i > arguments.length ? lt.queue(this[0], t) : n === e ? this : this.each(function() {
        ...
        promise: function(t, n) {
            ...
            for ("string" != typeof t && (n = t, t = e), t = t || "fx"; a--;) i = lt._data(s[a], t + "queueHooks"), i && i.empty && (o++, i.empty.add(l));
    ...
    lt.fn.extend({
        ...
        toggleClass: function(t, e) {
            var n = typeof t,
                i = "boolean" == typeof e;
            return this.each(lt.isFunction(t) ? function(n) {
                lt(this).toggleClass(t.call(this, n, this.className, e), e)
            } : function() {
                if ("string" === n)
                    for (var o, r = 0, s = lt(this), a = e, l = t.match(ut) || []; o = l[r++];) a = i ? a : !s.hasClass(o), s[a ? "addClass" : "removeClass"](o);
                else(n === U || "boolean" === n) && (this.className && lt._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : lt._data(this, "__className__") || "")
            })
        },
        hasClass: function(t) {
            for (var e = " " + t + " ", n = 0, i = this.length; i > n; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Et, " ").indexOf(e) >= 0) return !0;
            return !1
        },
        val: function(t) {
            var n, i, o, r = this[0];
            return arguments.length ? (o = lt.isFunction(t), this.each(function(n) {
                var r, s = lt(this);
                1 === this.nodeType && (r = o ? t.call(this, n, s.val()) : t, null == r ? r = "" : "number" == typeof r ? r += "" : lt.isArray(r) && (r = lt.map(r, function(t) {
                    return null == t ? "" : t + ""
                })), i = lt.valHooks[this.type] || lt.valHooks[this.nodeName.toLowerCase()], i && "set" in i && i.set(this, r, "value") !== e || (this.value = r))
            })) : r ? (i = lt.valHooks[r.type] || lt.valHooks[r.nodeName.toLowerCase()], i && "get" in i && (n = i.get(r, "value")) !== e ? n : (n = r.value, "string" == typeof n ? n.replace(At, "") : null == n ? "" : n)) : void 0
        }
    }), lt.extend({
        valHooks: {
            option: {
        ...
        attr: function(t, n, i) {
            ...
            return t && 3 !== a && 8 !== a && 2 !== a ? typeof t.getAttribute === U ? lt.prop(t, n, i) : (r = 1 !== a || !lt.isXMLDoc(t), r && (n = n.toLowerCase(), o = lt.attrHooks[n] || (Dt.test(n) ? St : Tt)), i === e ? o && r && "get" in o && null !== (s = o.get(t, n)) ? s : (typeof t.getAttribute !== U && (s = t.getAttribute(n)), null == s ? e : s) : null !== i ? o && r && "set" in o && (s = o.set(t, i, n)) !== e ? s : (t.setAttribute(n, i + ""), i) : (lt.removeAttr(t, n), e)) : void 0
        },
        removeAttr: function(t, e) {
            var n, i, o = 0,
                r = e && e.match(ut);
            if (r && 1 === t.nodeType)
                for (; n = r[o++];) i = lt.propFix[n] || n, Dt.test(n) ? !Nt && Mt.test(n) ? t[lt.camelCase("default-" + n)] = t[i] = !1 : t[i] = !1 : lt.attr(t, n, ""), t.removeAttribute(Nt ? n : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        prop: function(t, n, i) {
            var o, r, s, a = t.nodeType;
            return t && 3 !== a && 8 !== a && 2 !== a ? (s = 1 !== a || !lt.isXMLDoc(t), s && (n = lt.propFix[n] || n, r = lt.propHooks[n]), i !== e ? r && "set" in r && (o = r.set(t, i, n)) !== e ? o : t[n] = i : r && "get" in r && null !== (o = r.get(t, n)) ? o : t[n]) : void 0
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
                    var n = t.getAttributeNode("tabindex");
                    return n && n.specified ? parseInt(n.value, 10) : Bt.test(t.nodeName) || Ot.test(t.nodeName) && t.href ? 0 : e
                }
            }
        }
    }), St = {
        get: function(t, n) {
            var i = lt.prop(t, n),
                ...
                r = "boolean" == typeof i ? Lt && Nt ? null != o : Mt.test(n) ? t[lt.camelCase("default-" + n)] : !!o : t.getAttributeNode(n);
            return r && r.value !== !1 ? n.toLowerCase() : e;

        },
        set: function(t, e, n) {
            return e === !1 ? lt.removeAttr(t, n) : Lt && Nt || !Mt.test(n) ? t.setAttribute(!Nt && lt.propFix[n] || n, n) : t[lt.camelCase("default-" + n)] = t[n] = !0, n
        }
    }, Lt && Nt || (lt.attrHooks.value = {
        get: function(t, n) {
            var i = t.getAttributeNode(n);
            return lt.nodeName(t, "input") ? t.defaultValue : i && i.specified ? i.value : e
        },
        set: function(t, n, i) {
            return lt.nodeName(t, "input") ? (t.defaultValue = n, e) : Tt && Tt.set(t, n, i)
        }
    ...
    }, lt.each(["width", "height"], function(t, n) {
        ...
        lt.valHooks[this] = lt.extend(lt.valHooks[this], {
            set: function(t, n) {
                return lt.isArray(n) ? t.checked = lt.inArray(lt(t).val(), n) >= 0 : e
            }
        })
    });
    ...
    lt.event = {
            ...
            add: function(t, n, i, o, r) {
                var s, a, l, c, u, p, d, h, f, g, m, y = lt._data(t);
                if (y) {
                    for (i.handler && (c = i, i = c.handler, r = c.selector), i.guid || (i.guid = lt.guid++), (a = y.events) || (a = y.events = {}), (p = y.handle) || (p = y.handle = function(t) {
                            return typeof lt === U || t && lt.event.triggered === t.type ? e : lt.event.dispatch.apply(p.elem, arguments)
                        }, p.elem = t), n = (n || "").match(ut) || [""], l = n.length; l--;) s = Pt.exec(n[l]) || [], f = m = s[1], g = (s[2] || "").split(".").sort(), u = lt.event.special[f] || {}, f = (r ? u.delegateType : u.bindType) || f, u = lt.event.special[f] || {}, d = lt.extend({
                        type: f,
                        origType: m,
                        data: o,
                        handler: i,
                        ...
                        namespace: g.join(".")
                    }, c), (h = a[f]) || (h = a[f] = [], h.delegateCount = 0, u.setup && u.setup.call(t, o, g, p) !== !1 || (t.addEventListener ? t.addEventListener(f, p, !1) : t.attachEvent && t.attachEvent("on" + f, p))), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), r ? h.splice(h.delegateCount++, 0, d) : h.push(d), lt.event.global[f] = !0;
                    t = null
                }
            },
            remove: function(t, e, n, i, o) {
                var r, s, a, l, c, u, p, d, h, f, g, m = lt.hasData(t) && lt._data(t);
                if (m && (u = m.events)) {
                    for (e = (e || "").match(ut) || [""], c = e.length; c--;)
                        if (a = Pt.exec(e[c]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
                            for (p = lt.event.special[h] || {}, h = (i ? p.delegateType : p.bindType) || h, d = u[h] || [], a = a[2] && RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = d.length; r--;) s = d[r], !o && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(r, 1), s.selector && d.delegateCount--, p.remove && p.remove.call(t, s));
                            l && !d.length && (p.teardown && p.teardown.call(t, f, m.handle) !== !1 || lt.removeEvent(t, h, m.handle), delete u[h])
                        } else
                            for (h in u) lt.event.remove(t, h + e[c], n, i, !0);
                    lt.isEmptyObject(u) && (delete m.handle, lt._removeData(t, "events"))
                }
            },
            trigger: function(n, i, o, r) {
                var s, a, l, c, u, p, d, h = [o || Y],
                    f = st.call(n, "type") ? n.type : n,
                    g = st.call(n, "namespace") ? n.namespace.split(".") : [];
                if (l = p = o = o || Y, 3 !== o.nodeType && 8 !== o.nodeType && !Ft.test(f + lt.event.triggered) && (f.indexOf(".") >= 0 && (g = f.split("."), f = g.shift(), g.sort()), a = 0 > f.indexOf(":") && "on" + f, n = n[lt.expando] ? n : new lt.Event(f, "object" == typeof n && n), n.isTrigger = !0, n.namespace = g.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = e, n.target || (n.target = o), i = null == i ? [n] : lt.makeArray(i, [n]), u = lt.event.special[f] || {}, r || !u.trigger || u.trigger.apply(o, i) !== !1)) {
                    if (!r && !u.noBubble && !lt.isWindow(o)) {
                        for (c = u.delegateType || f, Ft.test(c + f) || (l = l.parentNode); l; l = l.parentNode) h.push(l), p = l;
                        p === (o.ownerDocument || Y) && h.push(p.defaultView || p.parentWindow || t)
                    }
                    for (d = 0;
                        (l = h[d++]) && !n.isPropagationStopped();) n.type = d > 1 ? c : u.bindType || f, s = (lt._data(l, "events") || {})[n.type] && lt._data(l, "handle"), s && s.apply(l, i), s = a && l[a], s && lt.acceptData(l) && s.apply && s.apply(l, i) === !1 && n.preventDefault();
                    if (n.type = f, !(r || n.isDefaultPrevented() || u._default && u._default.apply(o.ownerDocument, i) !== !1 || "click" === f && lt.nodeName(o, "a") || !lt.acceptData(o) || !a || !o[f] || lt.isWindow(o))) {
                        p = o[a], p && (o[a] = null), lt.event.triggered = f;
                        try {
                            o[f]()
                        } catch (m) {}
                        lt.event.triggered = e, p && (o[a] = p)
                    }
                    return n.result
                }
            },
            dispatch: function(t) {
                ...
                if (l[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                    for (a = lt.event.handlers.call(this, t, c), n = 0;
                        (r = a[n++]) && !t.isPropagationStopped();)
                        for (t.currentTarget = r.elem, s = 0;
                            (o = r.handlers[s++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(o.namespace)) && (t.handleObj = o, t.data = o.data, i = ((lt.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l), i !== e && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                if (l && c.nodeType && (!t.button || "click" !== t.type))
                    for (; c != this; c = c.parentNode || this)
                        if (1 === c.nodeType && (c.disabled !== !0 || "click" !== t.type)) {
                            for (r = [], s = 0; l > s; s++) o = n[s], i = o.selector + " ", r[i] === e && (r[i] = o.needsContext ? lt(i, this).index(c) >= 0 : lt.find(i, this, null, [c]).length), r[i] && r.push(o);
                            r.length && a.push({
                                elem: c,
                                handlers: r
                            })
            ...
            fix: function(t) {
                ...
                var e, n, i, o = t.type,
                    r = t,
                    s = this.fixHooks[o];
                for (s || (this.fixHooks[o] = s = Ht.test(o) ? this.mouseHooks : $t.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new lt.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
                return t.target || (t.target = r.srcElement || Y), 3 === t.target.nodeType && (t.target = t.target.parentNode), t.metaKey = !!t.metaKey, s.filter ? s.filter(t, r) : t
            },
        ...
        }, lt.removeEvent = Y.removeEventListener ? function(t, e, n) {
            t.removeEventListener && t.removeEventListener(e, n, !1)
        } : function(t, e, n) {
            var i = "on" + e;
            t.detachEvent && (typeof t[i] === U && (t[i] = null), t.detachEvent(i, n))
        }, lt.Event = function(t, n) {
            return this instanceof lt.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || t.returnValue === !1 || t.getPreventDefault && t.getPreventDefault() ? l : c) : this.type = t, n && lt.extend(this, n), this.timeStamp = t && t.timeStamp || lt.now(), this[lt.expando] = !0, e) : new lt.Event(t, n)
        }, lt.Event.prototype = {
            ...
            setup: function() {
                return It.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (lt.event.add(this, "propertychange._change", function(t) {
                    ...
                    var e = t.target;
                    It.test(e.nodeName) && !lt._data(e, "changeBubbles") && (lt.event.add(e, "change._change", function(t) {
            ...
            triggerHandler: function(t, n) {
                var i = this[0];
                return i ? lt.event.trigger(t, n, i, !0) : e
            }
        }),
        function(t, e) {
            function n(t) {
            ...
            function s(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : P) !== O && B(e), e = e || O, n = n || [], !t || "string" != typeof t) return n;
                ...
                if (!M && !i) {
                    if (o = gt.exec(t))
                        if (s = o[1]) {
                            ...
                            } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && $(e, r) && r.id === s) return n.push(r), n
                        } else {
                            if (o[2]) return Z.apply(n, J.call(e.getElementsByTagName(t), 0)), n;
                            if ((s = o[3]) && Q.getByClassName && e.getElementsByClassName) return Z.apply(n, J.call(e.getElementsByClassName(s), 0)), n
                        }
                    if (Q.qsa && !N.test(t)) {
                        if (u = !0, h = F, f = e, g = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = p(t), (u = e.getAttribute("id")) ? h = u.replace(vt, "\\$&") : e.setAttribute("id", h), h = "[id='" + h + "'] ", l = c.length; l--;) c[l] = h + d(c[l]);
                            f = ht.test(t) && e.parentNode || e, g = c.join(",")
                        }
                        if (g) try {
                            return Z.apply(n, J.call(f.querySelectorAll(g), 0)), n
                        } catch (m) {} finally {
            ...
            function a(t, e) {
                var n = e && t,
                    i = n && (~e.sourceIndex || Y) - (~t.sourceIndex || Y);
                if (i) return i;
                if (n)
                    for (; n = n.nextSibling;)
                        if (n === e) return -1;
            ...
            function p(t, e) {
                var n, i, o, r, a, l, c, u = R[t + " "];
                if (u) return e ? 0 : u.slice(0);
                for (a = t, l = [], c = j.preFilter; a;) {
                    (!n || (i = at.exec(a))) && (i && (a = a.slice(i[0].length) || a), l.push(o = [])), n = !1, (i = ct.exec(a)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(st, " ")
                    }), a = a.slice(n.length));
                    for (r in j.filter) !(i = dt[r].exec(a)) || c[r] && !(i = c[r](i)) || (n = i.shift(), o.push({
                        value: n,
                        type: r,
                        matches: i
                    }), a = a.slice(n.length));
                ...
                return e ? a.length : a ? s.error(t) : R(t, l).slice(0)
            }
            ...
            function h(t, e, n) {
                ...
                return e.first ? function(e, n, r) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || o)
                                if (c = e[F] || (e[F] = {}), (l = c[i]) && l[0] === u) {
                                    if ((a = l[1]) === !0 || a === C) return a === !0
                                } else if (l = c[i] = [u], l[1] = t(e, n, s) || C, l[1] === !0) return !0
                }
            }
            ...
            function m(t, e, n, i, r, s) {
                return i && !i[F] && (i = m(i)), r && !r[F] && (r = m(r, s)), o(function(o, s, a, l) {
                    var c, u, p, d = [],
                        ...
                        v = n ? r || (o ? t : f || i) ? [] : s : y;
                    if (n && n(y, v, a, l), i)
                        for (c = g(v, h), i(c, [], a, l), u = c.length; u--;)(p = c[u]) && (v[h[u]] = !(y[h[u]] = p));
                    if (o) {
                        if (r || t) {
                            if (r) {
                            ...
                            for (u = v.length; u--;)(p = v[u]) && (c = r ? K.call(o, p) : d[u]) > -1 && (o[c] = !(s[c] = p))
                        }
                    } else v = g(v === s ? v.splice(f, v.length) : v), r ? r(null, s, v, l) : Z.apply(s, v)
                })
            }

            function y(t) {
                for (var e, n, i, o = t.length, r = j.relative[t[0].type], s = r || j.relative[" "], a = r ? 1 : 0, l = h(function(t) {
                        return t === e
                    }, s, !0), c = h(function(t) {
                        return K.call(e, t) > -1
                    ...
                    if (n = j.relative[t[a].type]) u = [h(f(u), n)];
                    else {
                        if (n = j.filter[t[a].type].apply(null, t[a].matches), n[F]) {
                            for (i = ++a; o > i && !j.relative[t[i].type]; i++);
                            return m(a > 1 && f(u), a > 1 && d(t.slice(0, a - 1)).replace(st, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && d(t))
                        }
                        u.push(n)
                    }
                return f(u)
                ...
                var n = 0,
                    ...
                    a = function(o, a, l, c, u) {
                        var p, d, h, f = [],
                            ...
                            x = null != u,
                            b = A,
                            _ = o || r && j.find.TAG("*", u && a.parentNode || a),
                            w = W += null == b ? 1 : Math.random() || .1;
                        for (x && (A = a !== O && a, C = n); null != (p = _[y]); y++) {
                            if (r && p) {
                                for (d = 0; h = t[d++];)
                                    if (h(p, a, l)) {
                                        c.push(p);
                            ...
                            i && ((p = !h && p) && m--, o && v.push(p))
                        }
                        if (m += y, i && y !== m) {
                            for (d = 0; h = e[d++];) h(v, f, a, l);
                            if (o) {
                                if (m > 0)
                                    for (; y--;) v[y] || f[y] || (f[y] = G.call(c));
                                f = g(f)
                            }
                            Z.apply(c, f), x && !o && f.length > 0 && m + e.length > 1 && s.uniqueSort(c)
                        }
                        return x && (W = w, A = b), v
                    };
                return i ? o(a) : a
            ...
            function b(t, e, n, i) {
                var o, r, s, a, l, c = p(t);
                if (!i && 1 === c.length) {
                    if (r = c[0] = c[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === e.nodeType && !M && j.relative[r[1].type]) {
                        if (e = j.find.ID(s.matches[0].replace(bt, _t), e)[0], !e) return n;
                        t = t.slice(r.shift().value.length)
                    }
                    for (o = dt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !j.relative[a = s.type]);)
                        if ((l = j.find[a]) && (i = l(s.matches[0].replace(bt, _t), ht.test(r[0].type) && e.parentNode || e))) {
                            if (r.splice(o, 1), t = i.length && d(r), !t) return Z.apply(n, J.call(i, 0)), n;
                            break
                        }
                }
                return S(t, c)(i, e, M, n, ht.test(t)), n
            }

            function _() {}
            var w, C, j, k, T, S, E, A, B, O, D, M, N, L, I, $, H, F = "sizzle" + -new Date,
                P = t.document,
                Q = {},
                W = 0,
                q = 0,
            ...
            T = s.isXML = function(t) {
            ...
            }, B = s.setDocument = function(t) {
                var i = t ? t.ownerDocument || t : P;
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, D = i.documentElement, M = T(i), Q.tagNameNoComments = r(function(t) {
                    return t.appendChild(i.createComment("")), !t.getElementsByTagName("*").length
                }), Q.attributes = r(function(t) {
                    t.innerHTML = "<select></select>";
                    var e = typeof t.lastChild.getAttribute("multiple");
                    return "boolean" !== e && "string" !== e
                }), Q.getByClassName = r(function(t) {
                ...
                }), Q.getByName = r(function(t) {
                    t.id = F + 0, t.innerHTML = "<a name='" + F + "'></a><div name='" + F + "'></div>", D.insertBefore(t, D.firstChild);
                    var e = i.getElementsByName && i.getElementsByName(F).length === 2 + i.getElementsByName(F + 0).length;
                    return Q.getIdNotName = !i.getElementById(F), D.removeChild(t), e
                }), j.attrHandle = r(function(t) {
                ...
                }, Q.getIdNotName ? (j.find.ID = function(t, e) {
                ...
                }), j.find.TAG = Q.tagNameNoComments ? function(t, n) {
                    ...
                    return r
                }, j.find.NAME = Q.getByName && function(t, n) {
                    return typeof n.getElementsByName !== U ? n.getElementsByName(name) : e
                }, j.find.CLASS = Q.getByClassName && function(t, n) {
                    return typeof n.getElementsByClassName === U || M ? e : n.getElementsByClassName(t)
                }, L = [], N = [":focus"], (Q.qsa = n(i.querySelectorAll)) && (r(function(t) {
                ...
                })), (Q.matchesSelector = n(I = D.matchesSelector || D.mozMatchesSelector || D.webkitMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && r(function(t) {
                    Q.disconnectedMatch = I.call(t, "div"), I.call(t, "[s!='']:x"), L.push("!=", rt)
                }), N = RegExp(N.join("|")), L = RegExp(L.join("|")), $ = n(D.contains) || D.compareDocumentPosition ? function(t, e) {
                    ...
                    if (e)
                        for (; e = e.parentNode;)
                            if (e === t) return !0;
                    return !1
                }, H = D.compareDocumentPosition ? function(t, e) {
                    var n;
                    return t === e ? (E = !0, 0) : (n = e.compareDocumentPosition && t.compareDocumentPosition && t.compareDocumentPosition(e)) ? 1 & n || t.parentNode && 11 === t.parentNode.nodeType ? t === i || $(P, t) ? -1 : e === i || $(P, e) ? 1 : 0 : 4 & n ? -1 : 1 : t.compareDocumentPosition ? -1 : 1
                } : function(t, e) {
                    var n, o = 0,
                        r = t.parentNode,
                        s = e.parentNode,
                ...
                }, E = !1, [0, 0].sort(H), Q.detectDuplicates = E, O) : O
            }, s.matches = function(t, e) {
                return s(t, null, null, e)
            }, s.matchesSelector = function(t, e) {
                if ((t.ownerDocument || t) !== O && B(t), e = e.replace(xt, "='$1']"), !(!Q.matchesSelector || M || L && L.test(e) || N.test(e))) try {
                    var n = I.call(t, e);
                    if (n || Q.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
                } catch (i) {}
                return s(e, O, null, [t]).length > 0
            }, s.contains = function(t, e) {
                return (t.ownerDocument || t) !== O && B(t), $(t, e)
            }, s.attr = function(t, e) {
                var n;
                return (t.ownerDocument || t) !== O && B(t), M || (e = e.toLowerCase()), (n = j.attrHandle[e]) ? n(t) : M || Q.attributes ? t.getAttribute(e) : ((n = t.getAttributeNode(e)) || t.getAttribute(e)) && t[e] === !0 ? e : n && n.specified ? n.value : null
            }, s.error = function(t) {
                ...
                var e, n = [],
                    i = 1,
                    o = 0;
                if (E = !Q.detectDuplicates, t.sort(H), E) {
                    for (; e = t[i]; i++) e === t[i - 1] && (o = n.push(i));
                    for (; o--;) t.splice(n[o], 1)
                }
                return t
            }, k = s.getText = function(t) {
                var e, n = "",
                    i = 0,
                    o = t.nodeType;
                if (o) {
                ...
                preFilter: {
                    ATTR: function(t) {
                        return t[1] = t[1].replace(bt, _t), t[3] = (t[4] || t[5] || "").replace(bt, _t), "~=" === t[2] && (t[3] = " " + t[3] + " "), t.slice(0, 4)
                    },
                    CHILD: function(t) {
                    ...
                    PSEUDO: function(t) {
                        var e, n = !t[5] && t[2];
                        return dt.CHILD.test(t[0]) ? null : (t[4] ? t[2] = t[4] : n && ut.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(t) {
                    ...
                    CHILD: function(t, e, n, i, o) {
                        ...
                        return 1 === i && 0 === o ? function(t) {
                            ...
                            var c, u, p, d, h, f, g = r !== s ? "nextSibling" : "previousSibling",
                                m = e.parentNode,
                            ...
                            if (m) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && v) {
                                    for (u = m[F] || (m[F] = {}), c = u[t] || [], h = c[0] === W && c[1], d = c[0] === W && c[2], p = h && m.childNodes[h]; p = ++h && p && p[g] || (d = h = 0) || f.pop();)
                                        if (1 === p.nodeType && ++d && p === e) {
                                            u[t] = [W, h, d];
                                            break
                                        }
                                } else if (v && (c = (e[F] || (e[F] = {}))[t]) && c[0] === W) d = c[1];
                                else
                                    for (;
                                        (p = ++h && p && p[g] || (d = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++d || (v && ((p[F] || (p[F] = {}))[t] = [W, d]), p !== e)););
                                return d -= o, d === i || 0 === d % i && d / i >= 0
                            }
                        }
                    },
                    PSEUDO: function(t, e) {
                        var n, i = j.pseudos[t] || j.setFilters[t.toLowerCase()] || s.error("unsupported pseudo: " + t);
                        return i[F] ? i(e) : i.length > 1 ? (n = [t, t, "", e], j.setFilters.hasOwnProperty(t.toLowerCase()) ? o(function(t, n) {
                            for (var o, r = i(t, e), s = r.length; s--;) o = K.call(t, r[s]), t[o] = !(n[o] = r[s])
                        }) : function(t) {
                            return i(t, 0, n)
                        }) : i
                    }
                ...
                pseudos: {
                    ...
                    lang: o(function(t) {
                        return pt.test(t || "") || s.error("unsupported lang: " + t), t = t.replace(bt, _t).toLowerCase(),
                            function(e) {
                                var n;
                                do
                                    if (n = M ? e.getAttribute("xml:lang") || e.getAttribute("lang") : e.lang) return n = n.toLowerCase(), n === t || 0 === n.indexOf(t + "-");
            ...
            S = s.compile = function(t, e) {
                ...
                return r
            }, j.pseudos.nth = j.pseudos.eq, j.filters = _.prototype = j.pseudos, j.setFilters = new _, B(), s.attr = lt.attr, lt.find = s, lt.expr = s.selectors, lt.expr[":"] = lt.expr.pseudos, lt.unique = s.uniqueSort, lt.text = s.getText, lt.isXMLDoc = s.isXML, lt.contains = s.contains
        }(t);
    var Qt = /Until$/,
    ...
    lt.fn.extend({
        find: function(t) {
            ...
            for (n = [], e = 0; o > e; e++) lt.find(t, this[e], n);
        ...
        is: function(t) {
            return !!t && ("string" == typeof t ? zt.test(t) ? lt(t, this.context).index(this[0]) >= 0 : lt.filter(t, this).length > 0 : this.filter(t).length > 0)
        },
        closest: function(t, e) {
            for (var n, i = 0, o = this.length, r = [], s = zt.test(t) || "string" != typeof t ? lt(t, e || this.context) : 0; o > i; i++)
                for (n = this[i]; n && n.ownerDocument && n !== e && 11 !== n.nodeType;) {
                    if (s ? s.index(n) > -1 : lt.find.matchesSelector(n, t)) {
                        r.push(n);
                        break
                    }
                    n = n.parentNode
        ...
        lt.fn[t] = function(n, i) {
            ...
            return Qt.test(t) || (i = n), i && "string" == typeof i && (o = lt.filter(i, o)), o = this.length > 1 && !Rt[t] ? lt.unique(o) : o, this.length > 1 && Wt.test(t) && (o = o.reverse()), this.pushStack(o)
        }
    }), lt.extend({
    ...
    var Xt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        ae = d(Y),
        le = ae.appendChild(Y.createElement("div"));
    se.optgroup = se.option, se.tbody = se.tfoot = se.colgroup = se.caption = se.thead, se.th = se.td, lt.fn.extend({
        text: function(t) {
            return lt.access(this, function(t) {
                return t === e ? lt.text(this) : this.empty().append((this[0] && this[0].ownerDocument || Y).createTextNode(t))
        ...
        remove: function(t, e) {
            for (var n, i = 0; null != (n = this[i]); i++)(!t || lt.filter(t, [n]).length > 0) && (e || 1 !== n.nodeType || lt.cleanData(x(n)), n.parentNode && (e && lt.contains(n.ownerDocument, n) && m(x(n, "script")), n.parentNode.removeChild(n)));
            return this
        },
        empty: function() {
        ...
        html: function(t) {
            return lt.access(this, function(t) {
                var n = this[0] || {},
                    i = 0,
                    o = this.length;
                if (t === e) return 1 === n.nodeType ? n.innerHTML.replace(Ut, "") : e;
                if (!("string" != typeof t || te.test(t) || !lt.support.htmlSerialize && Yt.test(t) || !lt.support.leadingWhitespace && Vt.test(t) || se[(Zt.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(Gt, "<$1></$2>");
                    try {
                        for (; o > i; i++) n = this[i] || {}, 1 === n.nodeType && (lt.cleanData(x(n, !1)), n.innerHTML = t);
                        n = 0
                    } catch (r) {}
                }
        ...
        domManip: function(t, n, i) {
            ...
            var o, r, s, a, l, c, u = 0,
                ...
                y = t[0],
                v = lt.isFunction(y);
            if (v || !(1 >= p || "string" != typeof y || lt.support.checkClone) && ne.test(y)) return this.each(function(o) {
                var r = d.eq(o);
                v && (t[0] = y.call(this, o, n ? r.html() : e)), r.domManip(t, n, i)
            });
            if (p && (c = lt.buildFragment(t, this[0].ownerDocument, !1, this), o = c.firstChild, 1 === c.childNodes.length && (c = o), o)) {
                for (n = n && lt.nodeName(o, "tr"), a = lt.map(x(c, "script"), f), s = a.length; p > u; u++) r = c, u !== m && (r = lt.clone(r, !0, !0), s && lt.merge(a, x(r, "script"))), i.call(n && lt.nodeName(this[u], "table") ? h(this[u], "tbody") : this[u], r, u);
                if (s)
                    for (l = a[a.length - 1].ownerDocument, lt.map(a, g), u = 0; s > u; u++) r = a[u], ie.test(r.type || "") && !lt._data(r, "globalEval") && lt.contains(l, r) && (r.src ? lt.ajax({
                        url: r.src,
                        type: "GET",
                        dataType: "script",
                        async: !1,
        ...
        lt.fn[t] = function(t) {
            for (var n, i = 0, o = [], r = lt(t), s = r.length - 1; s >= i; i++) n = i === s ? this : this.clone(!0), lt(r[i])[e](n), nt.apply(o, n.get());
            return this.pushStack(o)
        }
    }), lt.extend({
        clone: function(t, e, n) {
            var i, o, r, s, a, l = lt.contains(t.ownerDocument, t);
            if (lt.support.html5Clone || lt.isXMLDoc(t) || !Yt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (le.innerHTML = t.outerHTML, le.removeChild(r = le.firstChild)), !(lt.support.noCloneEvent && lt.support.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || lt.isXMLDoc(t)))
                for (i = x(r), a = x(t), s = 0; null != (o = a[s]); ++s) i[s] && v(o, i[s]);
            if (e)
                if (n)
                    for (a = a || x(t), i = i || x(r), s = 0; null != (o = a[s]); s++) y(o, i[s]);
                else y(t, r);
            return i = x(r, "script"), i.length > 0 && m(i, !l && x(t, "script")), i = a = o = null, r
        },
        buildFragment: function(t, e, n, i) {
            for (var o, r, s, a, l, c, u, p = t.length, h = d(e), f = [], g = 0; p > g; g++)
                if (r = t[g], r || 0 === r)
                    if ("object" === lt.type(r)) lt.merge(f, r.nodeType ? [r] : r);
                    else if (Kt.test(r)) {
                for (a = a || h.appendChild(e.createElement("div")), l = (Zt.exec(r) || ["", ""])[1].toLowerCase(), u = se[l] || se._default, a.innerHTML = u[1] + r.replace(Gt, "<$1></$2>") + u[2], o = u[0]; o--;) a = a.lastChild;
                if (!lt.support.leadingWhitespace && Vt.test(r) && f.push(e.createTextNode(Vt.exec(r)[0])), !lt.support.tbody)
            ...
            for (a && h.removeChild(a), lt.support.appendChecked || lt.grep(x(f, "input"), b), g = 0; r = f[g++];)
                if ((!i || -1 === lt.inArray(r, i)) && (s = lt.contains(r.ownerDocument, r), a = x(h.appendChild(r), "script"), s && m(a), n))
                    for (o = 0; r = a[o++];) ie.test(r.type || "") && n.push(r);
            return a = null, h
        },
        cleanData: function(t, e) {
            for (var n, i, o, r, s = 0, a = lt.expando, l = lt.cache, c = lt.support.deleteExpando, u = lt.event.special; null != (n = t[s]); s++)
                if ((e || lt.acceptData(n)) && (o = n[a], r = o && l[o])) {
                    if (r.events)
                        for (i in r.events) u[i] ? lt.event.remove(n, i) : lt.removeEvent(n, i, r.handle);
                    l[o] && (delete l[o], c ? delete n[a] : typeof n.removeAttribute !== U ? n.removeAttribute(a) : n[a] = null, K.push(o))
                }
        }
    });
    ...
    lt.fn.extend({
        css: function(t, n) {
            return lt.access(this, function(t, n, i) {
                var o, r, s = {},
                    a = 0;
                if (lt.isArray(n)) {
                    for (r = ue(t), o = n.length; o > a; a++) s[n[a]] = lt.css(t, n[a], !1, r);
                    return s
                }
        ...
        toggle: function(t) {
            ...
            return this.each(function() {
                (e ? t : w(this)) ? lt(this).show(): lt(this).hide()
            })
        }
    }), lt.extend({
        cssHooks: {
        ...
        style: function(t, n, i, o) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, a, l = lt.camelCase(n),
                    c = t.style;
                if (n = lt.cssProps[l] || (lt.cssProps[l] = _(c, l)), a = lt.cssHooks[n] || lt.cssHooks[l], i === e) return a && "get" in a && (r = a.get(t, !1, o)) !== e ? r : c[n];
                if (s = typeof i, "string" === s && (r = xe.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(lt.css(t, n)), s = "number"), !(null == i || "number" === s && isNaN(i) || ("number" !== s || lt.cssNumber[l] || (i += "px"), lt.support.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (c[n] = "inherit"), a && "set" in a && (i = a.set(t, i, o)) === e))) try {
                    c[n] = i
                } catch (u) {}
            }
        },
        css: function(t, n, i, o) {
            var r, s, a, l = lt.camelCase(n);
            return n = lt.cssProps[l] || (lt.cssProps[l] = _(t.style, l)), a = lt.cssHooks[n] || lt.cssHooks[l], a && "get" in a && (s = a.get(t, !0, i)), s === e && (s = pe(t, n, o)), "normal" === s && n in we && (s = we[n]), "" === i || i ? (r = parseFloat(s), i === !0 || lt.isNumeric(r) ? r || 0 : s) : s
        },
        ...
        var o, r, s, a = i || ue(t),
            ...
            c = t.style;
        return a && ("" !== l || lt.contains(t.ownerDocument, t) || (l = lt.style(t, n)), ve.test(l) && me.test(n) && (o = c.width, r = c.minWidth, s = c.maxWidth, c.minWidth = c.maxWidth = c.width = l, l = a.width, c.width = o, c.minWidth = r, c.maxWidth = s)), l
        ...
        var o, r, s, a = i || ue(t),
            l = a ? a[n] : e,
            c = t.style;
        return null == l && c && c[n] && (l = c[n]), ve.test(l) && !fe.test(n) && (o = c.left, r = t.runtimeStyle, s = r && r.left, s && (r.left = t.currentStyle.left), c.left = "fontSize" === n ? "1em" : l, l = c.pixelLeft + "px", c.left = o, s && (r.left = s)), "" === l ? "auto" : l
    }), lt.each(["height", "width"], function(t, n) {
        lt.cssHooks[n] = {
            get: function(t, i, o) {
                return i ? 0 === t.offsetWidth && ge.test(lt.css(t, "display")) ? lt.swap(t, _e, function() {
                    return T(t, n, o)
                }) : T(t, n, o) : e
            },
            set: function(t, e, i) {
                var o = i && ue(t);
                return j(t, e, i ? k(t, n, i, lt.support.boxSizing && "border-box" === lt.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
    }), lt.support.opacity || (lt.cssHooks.opacity = {
        get: function(t, e) {
            return he.test((e && t.currentStyle ? t.currentStyle.filter : t.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : e ? "1" : ""
        },
        set: function(t, e) {
            var n = t.style,
                i = t.currentStyle,
            ...
            n.zoom = 1, (e >= 1 || "" === e) && "" === lt.trim(r.replace(de, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = de.test(r) ? r.replace(de, o) : r + " " + o)
        }
    }), lt(function() {
        ...
        }), !lt.support.pixelPosition && lt.fn.position && lt.each(["top", "left"], function(t, n) {
            lt.cssHooks[n] = {
                get: function(t, i) {
                    return i ? (i = pe(t, n), ve.test(i) ? lt(t).position()[n] + "px" : i) : e
                }
            }
        })
        ...
        }, me.test(t) || (lt.cssHooks[t + e].set = j)
    });
    var ke = /%20/g,
        Te = /\[\]$/,
        Se = /\r?\n/g,
    ...
    lt.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !lt(this).is(":disabled") && Ae.test(this.nodeName) && !Ee.test(t) && (this.checked || !ee.test(t))
            }).map(function(t, e) {
                var n = lt(this).val();
    ...
    Be = Pe.exec(Oe.toLowerCase()) || [], lt.fn.load = function(t, n, i) {
        if ("string" != typeof t && Qe) return Qe.apply(this, arguments);
        var o, r, s, a = this,
            l = t.indexOf(" ");
        return l >= 0 && (o = t.slice(l, t.length), t = t.slice(0, l)), lt.isFunction(n) ? (i = n, n = e) : n && "object" == typeof n && (s = "POST"), a.length > 0 && lt.ajax({
            url: t,
            type: s,
            dataType: "html",
            data: n
        }).done(function(t) {
            r = arguments, a.html(o ? lt("<div>").append(lt.parseHTML(t)).find(o) : t)
        ...
        ajax: function(t, n) {
            function i(t, n, i, o) {
                var r, p, v, x, _, C = n;
                2 !== b && (b = 2, l && clearTimeout(l), u = e, a = o || "", w.readyState = t > 0 ? 4 : 0, i && (x = M(d, w, i)), t >= 200 && 300 > t || 304 === t ? (d.ifModified && (_ = w.getResponseHeader("Last-Modified"), _ && (lt.lastModified[s] = _), _ = w.getResponseHeader("etag"), _ && (lt.etag[s] = _)), 204 === t ? (r = !0, C = "nocontent") : 304 === t ? (r = !0, C = "notmodified") : (r = N(d, x), C = r.state, p = r.data, v = r.error, r = !v)) : (v = C, (t || !C) && (C = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (n || C) + "", r ? g.resolveWith(h, [p, C, w]) : g.rejectWith(h, [w, C, v]), w.statusCode(y), y = e, c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [w, d, r ? p : v]), m.fireWith(h, [w, C]), c && (f.trigger("ajaxComplete", [w, d]), --lt.active || lt.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = e), n = n || {};
            var o, r, s, a, l, c, u, p, d = lt.ajaxSetup({}, n),
                h = d.context || d,
                f = d.context && (h.nodeType || h.jquery) ? lt(h) : lt.event,
                g = lt.Deferred(),
            ...
            if (g.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Oe) + "").replace(Ne, "").replace(Fe, Be[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = lt.trim(d.dataType || "*").toLowerCase().match(ut) || [""], null == d.crossDomain && (o = Pe.exec(d.url.toLowerCase()), d.crossDomain = !(!o || o[1] === Be[1] && o[2] === Be[2] && (o[3] || ("http:" === o[1] ? 80 : 443)) == (Be[3] || ("http:" === Be[1] ? 80 : 443)))), d.data && d.processData && "string" != typeof d.data && (d.data = lt.param(d.data, d.traditional)), O(We, d, n, w), 2 === b) return w;
            c = d.global, c && 0 === lt.active++ && lt.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !He.test(d.type), s = d.url, d.hasContent || (d.data && (s = d.url += (Me.test(s) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Le.test(s) ? s.replace(Le, "$1_=" + De++) : s + (Me.test(s) ? "&" : "?") + "_=" + De++)), d.ifModified && (lt.lastModified[s] && w.setRequestHeader("If-Modified-Since", lt.lastModified[s]), lt.etag[s] && w.setRequestHeader("If-None-Match", lt.etag[s])), (d.data && d.hasContent && d.contentType !== !1 || n.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + ze + "; q=0.01" : "") : d.accepts["*"]);
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function(e, o) {
                    n = Y.createElement("script"), n.async = !0, t.scriptCharset && (n.charset = t.scriptCharset), n.src = t.url, n.onload = n.onreadystatechange = function(t, e) {
    ...
    lt.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = Xe.pop() || lt.expando + "_" + De++;
            return this[t] = !0, t
        }
    }), lt.ajaxPrefilter("json jsonp", function(n, i, o) {
        var r, s, a, l = n.jsonp !== !1 && (Ue.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Ue.test(n.data) && "data");
        return l || "jsonp" === n.dataTypes[0] ? (r = n.jsonpCallback = lt.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Ue, "$1" + r) : n.jsonp !== !1 && (n.url += (Me.test(n.url) ? "&" : "?") + n.jsonp + "=" + r), n.converters["script json"] = function() {
            return a || lt.error(r + " was not called"), a[0]
        }, n.dataTypes[0] = "json", s = t[r], t[r] = function() {
            a = arguments
        }, o.always(function() {
            t[r] = s, n[r] && (n.jsonpCallback = i.jsonpCallback, Xe.push(r)), a && lt.isFunction(s) && s(a[0]), a = s = e
        }), "script") : e
    });
    var Ye, Ve, Ge = 0,
    ...
    } : L, Ve = lt.ajaxSettings.xhr(), lt.support.cors = !!Ve && "withCredentials" in Ve, Ve = lt.support.ajax = !!Ve, Ve && lt.ajaxTransport(function(n) {
                    ...
                    l.send(n.hasContent && n.data || null), i = function(t, o) {
                        ...
                        try {
                            if (i && (o || 4 === l.readyState))
                                if (i = e, s && (l.onreadystatechange = lt.noop, Ze && delete Ye[s]), o) 4 !== l.readyState && l.abort();
                                else {
                        ...
                        p && r(a, u, p, c)
                    }, n.async ? 4 === l.readyState ? setTimeout(i) : (s = ++Ge, Ze && (Ye || (Ye = {}, lt(t).unload(Ze)), Ye[s] = i), l.onreadystatechange = i) : i()
                },
                abort: function() {
                    i && i(e, !0)
                }
        ...
        rn = {
            "*": [function(t, e) {
                var n, i, o = this.createTween(t, e),
                    ...
                    c = 20;
                if (r) {
                    if (n = +r[2], i = r[3] || (lt.cssNumber[t] ? "" : "px"), "px" !== i && a) {
                        a = lt.css(o.elem, t, !0) || n || 1;
                        do l = l || ".5", a /= l, lt.style(o.elem, t, a + i); while (l !== (l = o.cur() / s) && 1 !== l && --c)
                    }
    ...
    lt.Animation = lt.extend(F, {
        ...
        run: function(t) {
            ...
            return this.pos = e = this.options.duration ? lt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : W.propHooks._default.set(this), this
        }
        ...
        var t, n = lt.timers,
            i = 0;
        for (Je = lt.now(); n.length > i; i++) t = n[i], t() || n[i] !== t || n.splice(i--, 1);
        ...
        var n, i, o = {
            ...
            r = this[0],
            s = r && r.ownerDocument;
        return s ? (n = s.documentElement, lt.contains(n, r) ? (typeof r.getBoundingClientRect !== U && (o = r.getBoundingClientRect()), i = z(s), {
        ...
        setOffset: function(t, e, n) {
            ...
            var o, r, s = lt(t),
                ...
                p = {},
                d = {};
            u ? (d = s.position(), o = d.top, r = d.left) : (o = parseFloat(l) || 0, r = parseFloat(c) || 0), lt.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (p.top = e.top - a.top + o), null != e.left && (p.left = e.left - a.left + r), "using" in e ? e.using.call(t, p) : s.css(p)
        }
    }, lt.fn.extend({
        position: function() {
            if (this[0]) {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || Y.documentElement; t && !lt.nodeName(t, "html") && "static" === lt.css(t, "position");) t = t.offsetParent;
        ...
        lt.fn[t] = function(o) {
            return lt.access(this, function(t, o, r) {
                var s = z(t);
                return r === e ? s ? n in s ? s[n] : s.document.documentElement[o] : t[o] : (s ? s.scrollTo(i ? lt(s).scrollLeft() : r, i ? r : lt(s).scrollTop()) : t[o] = r, e)
        ...
        lt.each({
            ...
            lt.fn[o] = function(o, r) {
                ...
                return lt.access(this, function(n, i, o) {
                    var r;
                    return lt.isWindow(n) ? n.document.documentElement["client" + t] : 9 === n.nodeType ? (r = n.documentElement, Math.max(n.body["scroll" + t], r["scroll" + t], n.body["offset" + t], r["offset" + t], r["client" + t])) : o === e ? lt.css(n, i, a) : lt.style(n, i, o, a)
                }, n, s ? o : e, s, null)
            }
        })
...
window.matchMedia || (window.matchMedia = function() {
    ...
    function(t, e, n) {
        ...
        function o(t) {
            var e, n, i, o, r, l = t || {};
            e = l.elements || s.getAllElements();
            for (var c = 0, u = e.length; u > c; c++)
                if (n = e[c], i = n.parentNode, o = void 0, r = void 0, "IMG" === n.nodeName.toUpperCase() && (n[s.ns] || (n[s.ns] = {}), l.reevaluate || !n[s.ns].evaluated)) {
        ...
        function r() {
            ...
            var i, r = setInterval(function() {
                    return o(), /^loaded|^i|^c/.test(e.readyState) ? void clearInterval(r) : void 0
                }, 250),
                a = function() {
                    o({
                        reevaluate: !0
        ...
        s.ns = "picturefill",
            function() {
            ...
            }, s.getWidthFromLength = function(t) {
                var n;
                if (!t || t.indexOf("%") > -1 != !1 || !(parseFloat(t) > 0 || t.indexOf("calc(") > -1)) return !1;
                t = t.replace("vw", "%"), s.lengthEl || (s.lengthEl = e.createElement("div"), s.lengthEl.style.cssText = "border:0;display:block;font-size:1em;left:0;margin:0;padding:0;position:absolute;visibility:hidden", s.lengthEl.className = "helper-from-picturefill-js"), s.lengthEl.style.width = "0px";
                try {
                    s.lengthEl.style.width = t
                } catch (i) {}
                return e.body.appendChild(s.lengthEl), n = s.lengthEl.offsetWidth, 0 >= n && (n = !1), e.body.removeChild(s.lengthEl), n
            }, s.detectTypeSupport = function(e, n) {
                var i = new t.Image;
                return i.onerror = function() {
                    s.types[e] = !1, o()
                }, i.onload = function() {
                    s.types[e] = 1 === i.width, o()
                }, i.src = n, "pending"
            }, s.types = s.types || {}, s.initTypeDetects = function() {
                s.types["image/jpeg"] = !0, s.types["image/gif"] = !0, s.types["image/png"] = !0, s.types["image/svg+xml"] = e.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), s.types["image/webp"] = s.detectTypeSupport("image/webp", "data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA=")
            }, s.verifyTypeSupport = function(t) {
                var e = t.getAttribute("type");
                if (null === e || "" === e) return !0;
                var n = s.types[e];
                return "string" == typeof n && "pending" !== n ? (s.types[e] = s.detectTypeSupport(e, n), "pending") : "function" == typeof n ? (n(), "pending") : n
            }, s.parseSize = function(t) {
                var e = /(\([^)]+\))?\s*(.+)/g.exec(t);
                return {
                    media: e && e[1],
                    length: e && e[2]
                ...
                for (var i, o = s.trim(n).split(/\s*,\s*/), r = 0, a = o.length; a > r; r++) {
                    var l = o[r],
                        ...
                        u = c.length,
                        p = c.media;
                    if (u && (!p || s.matchesMedia(p)) && (i = s.getWidthFromLength(u))) break
                }
                return i || Math.max(t.innerWidth || 0, e.documentElement.clientWidth)
            }, s.parseSrcset = function(t) {
                for (var e = [];
                    "" !== t;) {
                    t = t.replace(/^\s+/g, "");
                    var n, i = t.search(/\s/g),
                        o = null;
                    if (-1 !== i) {
                        n = t.slice(0, i);
                        var r = n.slice(-1);
                        if (("," === r || "" === n) && (n = n.replace(/,+$/, ""), o = ""), t = t.slice(i + 1), null === o) {
                ...
                return e
            }, s.parseDescriptor = function(t, e) {
                var n, i = e || "100vw",
                    o = t && t.replace(/(^\s+|\s+$)/g, ""),
                ...
                if (o)
                    for (var a = o.split(" "), l = a.length - 1; l >= 0; l--) {
                        ...
                        if ("h" !== u && "w" !== u || s.sizesSupported) {
                            if ("x" === u) {
                                var p = c && parseFloat(c, 10);
                                n = p && !isNaN(p) ? p : 1
                            }
                        } else n = parseFloat(parseInt(c, 10) / r)
                    }
                return n || 1
            }, s.getCandidatesFromSourceSet = function(t, e) {
                for (var n = s.parseSrcset(t), i = [], o = 0, r = n.length; r > o; o++) {
                    var a = n[o];
                    i.push({
                        url: a.url,
                        resolution: s.parseDescriptor(a.descriptor, e)
                    })
                }
                return i
            }, s.dodgeSrcset = function(t) {
                t.srcset && (t[s.ns].srcset = t.srcset, t.srcset = "", t.setAttribute("data-pfsrcset", t[s.ns].srcset))
            }, s.processSourceSet = function(t) {
                var e = t.getAttribute("srcset"),
                    n = t.getAttribute("sizes"),
                    i = [];
                return "IMG" === t.nodeName.toUpperCase() && t[s.ns] && t[s.ns].srcset && (e = t[s.ns].srcset), e && (i = s.getCandidatesFromSourceSet(e, n)), i
            }, s.backfaceVisibilityFix = function(t) {
                var e = t.style || {},
                    n = "webkitBackfaceVisibility" in e,
                    i = e.zoom;
                n && (e.zoom = ".999", n = t.offsetWidth, e.zoom = i)
                ...
                return function(o, r) {
                    var a;
                    o[s.ns] && !t.pfStopIntrinsicSize && (void 0 === o[s.ns].dims && (o[s.ns].dims = o.getAttribute("width") || o.getAttribute("height")), o[s.ns].dims || (r.url in n ? i(o, n[r.url], r.resolution) : (a = e.createElement("img"), a.onload = function() {
                        if (n[r.url] = a.width, !n[r.url]) try {
                            e.body.appendChild(a), n[r.url] = a.width || a.offsetWidth, e.body.removeChild(a)
                        } catch (t) {}
                        o.src === r.url && i(o, n[r.url], r.resolution), o = null, a.onload = null, a = null
                    }, a.src = r.url)))
                }
            }(), s.applyBestCandidate = function(t, e) {
                var n, i, o;
                t.sort(s.ascendingSort), i = t.length, o = t[i - 1];
                for (var r = 0; i > r; r++)
                    if (n = t[r], n.resolution >= s.getDpr()) {
                        o = n;
                        break
                    }
                o && (o.url = s.makeUrl(o.url), e.src !== o.url && (s.restrictsMixedContent() && "http:" === o.url.substr(0, "http:".length).toLowerCase() ? void 0 !== window.console && console.warn("Blocked mixed content image " + o.url) : (e.src = o.url, s.curSrcSupported || (e.currentSrc = e.src), s.backfaceVisibilityFix(e))), s.setIntrinsicSize(e, o))
            }, s.ascendingSort = function(t, e) {
                return t.resolution - e.resolution
            }, s.removeVideoShim = function(t) {
                var e = t.getElementsByTagName("video");
                if (e.length) {
                    for (var n = e[0], i = n.getElementsByTagName("source"); i.length;) t.insertBefore(i[0], n);
                    n.parentNode.removeChild(n)
                }
            }, s.getAllElements = function() {
                for (var t = [], n = e.getElementsByTagName("img"), i = 0, o = n.length; o > i; i++) {
                    var r = n[i];
                    ("PICTURE" === r.parentNode.nodeName.toUpperCase() || null !== r.getAttribute("srcset") || r[s.ns] && null !== r[s.ns].srcset) && t.push(r)
                }
                return t
            }, s.getMatch = function(t, e) {
                for (var n, i = e.childNodes, o = 0, r = i.length; r > o; o++) {
                    var a = i[o];
                    if (1 === a.nodeType) {
                        if (a === t) return n;
        ...
        t.fn.flowtype = function(e) {
            var n = t.extend({
                ...
                i = function(e) {
                    var i = t(e),
                        o = i.width(),
                        r = o > n.maximum ? n.maximum : o < n.minimum ? n.minimum : o,
                        s = r / n.fontRatio,
        ...
        t.MixItUp = function() {
            ...
            _addHook: function(e, n, i, o, r) {
                var s = t.MixItUp.prototype[e],
                    a = {};
                r = 1 === r || "post" === r ? "post" : "pre", a[n] = {}, a[n][r] = {}, a[n][r][i] = o, t.extend(!0, s, a)
            },
            _init: function(e, n) {
                var i = this;
            ...
            _platformDetect: function() {
                var t = this,
                    ...
                    a = s(t._domNode);
                t._execAction("_platformDetect", 0), t._chrome = o ? parseInt(o[1], 10) : !1, t._ff = r ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]) : !1, t._prefix = a.prefix, t._vendor = a.vendor, t._suckMode = window.atob && t._prefix ? !1 : !0, t._suckMode && (t.animation.enable = !1), t._ff && t._ff <= 4 && (t.animation.enable = !1);
            ...
            _processClick: function(n, i) {
                var o = this,
                    r = function(n, i, r) {
                        ...
                        s._handled["_" + i][o.selectors[i]] = s._handled["_" + i][o.selectors[i]] === e ? 1 : s._handled["_" + i][o.selectors[i]] + 1, s._handled["_" + i][o.selectors[i]] === s._bound["_" + i][o.selectors[i]] && (n[(r ? "remove" : "add") + "Class"](o.controls.activeClass), delete s._handled["_" + i][o.selectors[i]])
                    };
                if (o._execAction("_processClick", 0, arguments), !o._mixing || o.animation.queue && o._queue.length < o.animation.queueLimit) {
                    if (o._clicking = !0, "sort" === i) {
                        ...
                        (!n.hasClass(o.controls.activeClass) || s.indexOf("random") > -1) && (t(o.selectors.sort).removeClass(o.controls.activeClass), r(n, i), o.sort(s))
                    }
                    if ("filter" === i) {
                        var a, l = n.attr("data-filter"),
                            c = "or" === o.controls.toggleLogic ? "," : "";
                        o.controls.toggleFilterButtons ? (o._buildToggleArray(), n.hasClass(o.controls.activeClass) ? (r(n, i, !0), a = o._toggleArray.indexOf(l), o._toggleArray.splice(a, 1)) : (r(n, i), o._toggleArray.push(l)), o._toggleArray = t.grep(o._toggleArray, function(t) {
                            return t
                        }), o._toggleString = o._toggleArray.join(c), o.filter(o._toggleString)) : n.hasClass(o.controls.activeClass) || (t(o.selectors.filter).removeClass(o.controls.activeClass), r(n, i), o.filter(l))
                    }
            ...
            _updateControls: function(n, i) {
                ...
                for (var c = 0; 2 > c; c++) l = o.controls.live ? t(o.selectors[a]) : o["_$" + a + "Buttons"], l && s(l, "[data-" + a + '="' + r[a] + '"]'), a = "sort";
            ...
            _compare: function(t, e, n) {
                ...
                return a > s ? "asc" === o ? -1 : 1 : s > a ? "asc" === o ? 1 : -1 : s === a && i._newSort.length > n + 1 ? i._compare(t, e, n + 1) : 0
            },
            ...
            _goMix: function(t) {
                var e = this,
                    ...
                    i = function() {
                        ...
                        e._getInterMixData(), e._setFinal(), e._getFinalMixData(), window.pageYOffset !== t && window.scrollTo(n, t), e._prepTargets(), window.requestAnimationFrame ? requestAnimationFrame(o) : setTimeout(function() {
                            o()
                        }, 20)
                    },
                    o = function() {
            ...
            _animateTargets: function() {
                ...
                for (var n = 0; n < e._$toHide.length; n++) {
                    for (var i = e._$toHide[n], o = t(i), s = e._getDelay(n), u = {}, l = 0; 2 > l; l++) {
                        var c = 0 === l ? c = e._prefix : "";
            ...
            _execAction: function(t, e, n) {
                ...
                if (!i._actions.isEmptyObject && i._actions.hasOwnProperty(t))
                    for (var r in i._actions[t][o]) i._actions[t][o][r].call(i, n)
            },
                    ...
                    for (var a = 0; 4 > a; a++) {
                        switch (a) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                var l = t.MixItUp.prototype._helpers._camelCase(i + r[s])
                        }
                        if (o.style[l] !== e && "unknown" != typeof o.style[l] && o.style[l].length > 0 && (o.style[l] = ""), !i && 1 === a) break
                    }
    ...
    ! function(t, e, n) {
        ...
        t.fn.scrollUp = function(e) {
            ...
            var o, r, s, a, l, c, u, p = t.fn.scrollUp.settings = t.extend({}, t.fn.scrollUp.defaults, i),
                d = !1;
            switch (u = p.scrollTrigger ? t(p.scrollTrigger) : t("<a/>", {
                id: p.scrollName,
                href: "#top"
            }), p.scrollTitle && u.attr("title", p.scrollTitle), u.appendTo("body"), p.scrollImg || p.scrollTrigger || u.html(p.scrollText), u.css({
                display: "none",
                position: "fixed",
                zIndex: p.zIndex
            ...
            a = "top" === p.scrollFrom ? p.scrollDistance : t(n).height() - t(e).height() - p.scrollDistance, l = t(e).scroll(function() {
                t(e).scrollTop() > a ? d || (u[o](s), d = !0) : d && (u[r](s), d = !1)
            }), p.scrollTarget ? "number" == typeof p.scrollTarget ? c = p.scrollTarget : "string" == typeof p.scrollTarget && (c = Math.floor(t(p.scrollTarget).offset().top)) : c = 0, u.click(function(e) {
    ...
    }(jQuery, window, document), jBox.prototype.attach = function(t, e) {
        return t || (t = jQuery(this.options.attach.selector || this.options.attach)), e || (e = this.options.trigger), t && t.length && jQuery.each(t, function(t, n) {
            n = jQuery(n), n.data("jBox-attached-" + this.id) || ("title" == this.options.getContent && void 0 != n.attr("title") && n.data("jBox-getContent", n.attr("title")).removeAttr("title"), this.attachedElements || (this.attachedElements = []), this.attachedElements.push(n[0]), n.on(e + ".jBox-attach-" + this.id, function(t) {
                if (this.timer && clearTimeout(this.timer), "mouseenter" != e || !this.isOpen || this.source[0] != n[0]) {
                    if (this.isOpen && this.source && this.source[0] != n[0]) var i = !0;
                    this.source = n, !this.options.target && (this.target = n), "click" == e && this.options.preventDefault && t.preventDefault(), this["click" != e || i ? "open" : "toggle"]()
                }
            }.bind(this)), "mouseenter" == this.options.trigger && n.on("mouseleave", function(t) {
                (!this.options.closeOnMouseleave || t.relatedTarget != this.wrapper[0] && !jQuery(t.relatedTarget).parents("#" + this.id).length) && this.close()
            }.bind(this)), n.data("jBox-attached-" + this.id, e), this.options._onAttach && this.options._onAttach.bind(this)(n))
        }.bind(this)), this
    }, jBox.prototype.detach = function(t) {
        return t || (t = this.attachedElements || []), t && t.length && jQuery.each(t, function(t, e) {
            e = jQuery(e), e.data("jBox-attached-" + this.id) && (e.off(e.data("jBox-attached-" + this.id) + ".jBox-attach-" + this.id), e.data("jBox-attached-" + this.id, null)), this.attachedElements = jQuery.grep(this.attachedElements, function(t) {
                return t != e[0]
            })
        }.bind(this)), this
    }, jBox.prototype.setTitle = function(t, e) {
        ...
        return null == t || void 0 == t ? this : (!this.wrapper && this._create(), this.title || (this.titleContainer = jQuery("<div/>", {
            "class": "jBox-title"
        }), this.title = jQuery("<div/>").appendTo(this.titleContainer), this.wrapper.addClass("jBox-hasTitle"), ("title" == this.options.closeButton || this.options.closeButton === !0 && !this.options.overlay) && (this.wrapper.addClass("jBox-closeButton-title"), this.closeButton.appendTo(this.titleContainer)), this.titleContainer.insertBefore(this.content)), this.title.html(t), !e && this.options.repositionOnContent && (n != this.wrapper.height() || i != this.wrapper.width()) && this.position(), this)
    }, jBox.prototype.setContent = function(t, e) {
        if (null == t) return this;
        !this.wrapper && this._create();
        var n = this.wrapper.height(),
            i = this.wrapper.width(),
            o = jQuery("body").height(),
            r = jQuery("body").width();
        ...
        var s = {
            x: r - jQuery("body").width(),
            y: o - jQuery("body").height()
        };
        return !e && this.options.repositionOnContent && (n != this.wrapper.height() || i != this.wrapper.width()) && this.position({
            adjustOffset: s
        }), this
    }, jBox.prototype.setDimensions = function(t, e, n) {
        !this.wrapper && this._create(), this.content.css(t, e), (void 0 == n || n) && this.position()
    }, jBox.prototype.setWidth = function(t, e) {
        this.setDimensions("width", t, e)
    }, jBox.prototype.setHeight = function(t, e) {
        ...
        if (t || (t = {}), this.target = t.target || this.target || this.options.target || jQuery(window), this.dimensions = {
            ...
            }).length > 0) ? "fixed" : "static"), "fixed" == this.target.data("jBox-fixed") && this.options.fixed && (e.top = e.top - jQuery(window).scrollTop(), e.left = e.left - jQuery(window).scrollLeft()), this.targetDimensions = {
            ...
            var n = function(t) {
                ...
                var e = this.options.attributes[t] = "x" == t ? "left" : "top";
                return this.pos[e] = this.targetDimensions[e], "center" == this.options.position[t] ? void(this.pos[e] += Math.ceil((this.targetDimensions[t] - this.dimensions[t]) / 2)) : (e != this.options.position[t] && (this.pos[e] += this.targetDimensions[t] - this.dimensions[t]), void((this.options.outside == t || "xy" == this.options.outside) && (this.pos[e] += this.dimensions[t] * (e != this.options.position[t] ? 1 : -1))))
            }.bind(this);
            if (n("x"), n("y"), this.options.pointer && "number" != jQuery.type(this.options.position.x) && "number" != jQuery.type(this.options.position.y)) {
                var i = 0;
                switch (this.pointer.align) {
                    case "center":
                        "center" != this.options.position[this._getOpp(this.options.outside)] && (i += this.dimensions[this._getOpp(this.options.outside)] / 2);
                        break;
                    default:
                        switch (this.options.position[this._getOpp(this.options.outside)]) {
                            case "center":
                                i += (this.dimensions[this._getOpp(this.options.outside)] / 2 - this.pointer.dimensions[this._getOpp(this.options.outside)] / 2) * (this.pointer.align == this._getTL(this.pointer.align) ? 1 : -1);
                                break;
                            default:
                                i += this.pointer.align != this.options.position[this._getOpp(this.options.outside)] ? this.dimensions[this._getOpp(this.options.outside)] * (-1 !== jQuery.inArray(this.pointer.align, ["top", "left"]) ? 1 : -1) + this.pointer.dimensions[this._getOpp(this.options.outside)] / 2 * (-1 !== jQuery.inArray(this.pointer.align, ["top", "left"]) ? -1 : 1) : this.pointer.dimensions[this._getOpp(this.options.outside)] / 2 * (-1 !== jQuery.inArray(this.pointer.align, ["top", "left"]) ? 1 : -1)
                        }
                }
                i *= this.options.position[this._getOpp(this.options.outside)] == this.pointer.alignAttribute ? -1 : 1, i += this.pointer.offset * (this.pointer.align == this._getOpp(this._getTL(this.pointer.align)) ? 1 : -1), this.pos[this._getTL(this._getOpp(this.pointer.xy))] += i
            }
        ...
        return !this.options.delayOpen || this.isOpen || this.isClosing || t.ignoreDelay ? e() : this.timer = setTimeout(e, this.options.delayOpen), this
        ...
        return t.ignoreDelay ? e() : this.timer = setTimeout(e, Math.max(this.options.delayClose, 10)), this
        ...
        var e = jQuery.extend(!0, {}, this.options.ajax);
        this.ajaxRequest && this.ajaxRequest.abort();
        var n = t.beforeSend || e.beforeSend || function() {},
            i = t.complete || e.complete || function() {},
            o = jQuery.extend(!0, e, t);
        return o.beforeSend = function() {
            o.spinner && (this.wrapper.addClass("jBox-loading"), this.spinner = jQuery(o.spinner !== !0 ? o.spinner : '<div class="jBox-spinner"></div>').appendTo(this.container)), n.bind(this)()
        }.bind(this), o.complete = function(t) {
            this.wrapper.removeClass("jBox-loading"), this.spinner && this.spinner.remove(), o.setContent && this.setContent(t.responseText), this.ajaxLoaded = !0, i.bind(this)(t)
        ...
        if (!jBox._audio[t.url]) {
            ...
            jQuery("<source/>", {
                src: t.url + ".mp3"
            }).appendTo(e), jQuery("<source/>", {
                src: t.url + ".ogg"
            }).appendTo(e), jBox._audio[t.url] = e[0]
        }
    ...
    }(), jQuery.fn.jBox = function(t, e) {
        return t || (t = {}), e || (e = {}), new jBox(t, jQuery.extend(e, {
            attach: this
        }))
        ...
        t("#Container").mixItUp(), t.scrollUp({
            scrollName: "scrollUp",
            scrollDistance: 300,
            scrollFrom: "top",
            scrollSpeed: 1e3,
            ...
            activeOverlay: !1,
            zIndex: 8009
        }), t(".resume").jBox("Tooltip", {
            animation: "pulse",
            theme: "TooltipDark",
            closeOnClick: !0
        }), t(".miroLink").jBox("Tooltip", {
            animation: "tada",
            theme: "TooltipDark",
            closeOnClick: !0
        }), new jBox("Image", {
    ...
    function(t, e, n, i) {
        ...
        var o = n("html"),
            ...
            g = function(t, e) {
                ...
                return e && h(t) && (n = a.getViewport()[e] / 100 * n), Math.ceil(n)
            },
            m = function(t, e) {
                return g(t, e) + "px"
            };
        n.extend(a, {
            ...
            _setDimension: function() {
                var t, e, i, o, r, s, l, c, u, p, d, f, y, v, x, b = a.getViewport(),
                    _ = 0,
                    w = !1,
                    C = !1,
                    j = a.wrap,
                    ...
                    $ = g(I[1] + I[3]),
                    H = g(I[0] + I[2]);
                if (j.add(k).add(T).width("auto").height("auto").removeClass("fancybox-tmp"), t = g(k.outerWidth(!0) - k.width()), e = g(k.outerHeight(!0) - k.height()), i = $ + t, o = H + e, r = h(E) ? (b.w - i) * g(E) / 100 : E, s = h(A) ? (b.h - o) * g(A) / 100 : A, "iframe" === S.type) {
                    if (v = S.content, S.autoHeight && 1 === v.data("ready")) try {
                        v[0].contentWindow.document.location && (T.width(r).height(9999), x = v.contents().find("body"), L && x.css("overflow-x", "hidden"), s = x.outerHeight(!0))
                    } catch (F) {}
                } else(S.autoWidth || S.autoHeight) && (T.addClass("fancybox-tmp"), S.autoWidth || T.width(r), S.autoHeight || T.height(s), S.autoWidth && (r = T.width()), S.autoHeight && (s = T.height()), T.removeClass("fancybox-tmp"));
                if (E = g(r), A = g(s), u = r / s, B = g(h(B) ? g(B, "w") - i : B), D = g(h(D) ? g(D, "w") - i : D), O = g(h(O) ? g(O, "h") - o : O), M = g(h(M) ? g(M, "h") - o : M), l = D, c = M, S.fitToView && (D = Math.min(b.w - i, D), M = Math.min(b.h - o, M)), f = b.w - $, y = b.h - H, S.aspectRatio ? (E > D && (E = D, A = g(E / u)), A > M && (A = M, E = g(A * u)), B > E && (E = B, A = g(E / u)), O > A && (A = O, E = g(A * u))) : (E = Math.max(B, Math.min(E, D)), S.autoHeight && "iframe" !== S.type && (T.width(E), A = T.height()), A = Math.max(O, Math.min(A, M))), S.fitToView)
                    if (T.width(E).height(A), j.width(E + t), p = j.width(), d = j.height(), S.aspectRatio)
                        for (;
                            (p > f || d > y) && E > B && A > O && !(_++ > 19);) A = Math.max(O, Math.min(M, A - 10)), E = g(A * u), B > E && (E = B, A = g(E / u)), E > D && (E = D, A = g(E / u)), T.width(E).height(A), j.width(E + t), p = j.width(), d = j.height();
                    else E = Math.max(B, Math.min(E, E - (p - f))), A = Math.max(O, Math.min(A, A - (d - y)));
                L && "auto" === N && s > A && f > E + t + L && (E += L), T.width(E).height(A), j.width(E + t), p = j.width(), d = j.height(), w = (p > f || d > y) && E > B && A > O, C = S.aspectRatio ? l > E && c > A && r > E && s > A : (l > E || c > A) && (r > E || s > A), n.extend(S, {
                    dim: {
                        width: m(p),
                        height: m(d)
                    },
                ...
                }), !v && S.autoHeight && A > O && M > A && !C && T.height("auto")
            },
            ...
            beforeLoad: function(e, i) {
                ...
                for (o in e)
                    if (e.hasOwnProperty(o) && (r = e[o], s = l.match(r.matcher))) {
                        c = r.type, a = t.extend(!0, {}, r.params, i[o] || (t.isPlainObject(e[o]) ? e[o].params : null)), l = "function" === t.type(r.url) ? r.url.call(this, s, a, i) : n(r.url, s, a);
                        break
                    }
                c && (i.href = l, i.type = c, i.autoHeight = !1)
            }
        }
    }(jQuery), blarg = jQuery.noConflict(), blarg(document).ready(function() {
    ...
    function() {
        function t(t, e) {
            this.title = t, this.completed = e
        }

        function e() {
            var t, e = document.getElementById("todo-list"),
                n = c.length;
            for (e.innerHTML = "", t = 0; n > t; t++) {
                var i = c[t],
                    o = document.createElement("li");
                i.completed && (o.className += "completed");
                var r = document.createElement("input");
                r.className = "toggle", r.type = "checkbox", r.addEventListener("change", s), r.checked = i.completed, r.setAttribute("data-todo-id", t);
                var a = document.createElement("label");
                a.appendChild(document.createTextNode(i.title));
                var l = document.createElement("div");
                l.className = "view", l.appendChild(r), l.appendChild(a), o.appendChild(l), e.appendChild(o)
            }
        }
        ...
        function i() {
            ...
            for (e = 0, n = c.length; n > e; e++) {
                var i = c[e];
                "string" == typeof i && (c[e] = new t(i, !1))
            }
        }

        function o(t) {
            var n = localStorage.getItem("todo-list");
            n && (c = JSON.parse(n), i()), e()
        }

        function r() {
            localStorage.setItem("todo-list", JSON.stringify(c))
        }

        function s(t) {
            var n = t.target,
                i = n.getAttribute("data-todo-id"),
                o = c[i];
            o.completed = n.checked, r(), e()
        }

        function a(t) {
            if (13 === t.keyCode) {
                var i = document.getElementById("new-todo");
                n(i.value), e(), i.value = ""
            }
        }

        function l() {
            o(), document.getElementById("new-todo").addEventListener("keypress", a, !1)
        }
        var c = [];
